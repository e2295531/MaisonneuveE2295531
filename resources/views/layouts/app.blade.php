...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        <a href="{{route('etudiants.home')}}" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                <a href="{{route('etudiants.home')}}" class="nav-item nav-link active">Home</a>
                <a href="{{route('etudiants.index')}}" class="nav-item nav-link">liste des étudiants</a>
                <a href="{{route('villes.index')}}" class="nav-item nav-link">liste des villes</a>
